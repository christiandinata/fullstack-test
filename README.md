...
- [v] Setup Github Actions workflow file for lint check on PRs to `master`
- [v] Setup Github Actions workflow file to deploy on pushes to `master`
- [v] Deploy the website and submit the URL to us
